...
goog.provide('app.ConveyorBelt');

goog.require('b2');
goog.require('app.Unit');
goog.require('app.UserObject');
  
/**
 * ConveyorBelt class
 * Belt with user configurable surface velocity
 */
class ConveyorBelt extends UserObject {
  ...
  getBeltDirectionVector_(direction = this.currentDirection_) {
    return new b2.Vec2(CONVEYOR_BELT_SPEED * direction, 0);
  }
