 ...
 */
app.world.Dropper = class extends app.world.LevelObject {
  ...
  buildBody_() {
    ...
    const worldWidth = app.Unit.toWorld(this.config_.style.width);
    const worldHeight = app.Unit.toWorld(this.config_.style.height);
