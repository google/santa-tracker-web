...
app.ImageShapeStar.prototype.getSVGString = function(color) {
  var data = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 78.71 75"><defs><style>.cls-1{fill:' + color + ';}</style></defs><polygon class="cls-1" points="39.2 0 51.5 24.58 78.72 28.38 59.14 47.67 63.93 74.73 39.54 62.08 15.28 75 19.78 47.89 0 28.81 27.17 24.71 39.2 0"/></svg>';
  return data;
};
