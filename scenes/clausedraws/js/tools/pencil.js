...
app.Pencil.prototype = Object.create(app.Tool.prototype);
 ...
 */
app.Pencil.prototype.draw = function(canvas, mouseCoords, prevCanvas, size,
    color) {
 ...
 * Resets the pen path
 */
app.Pencil.prototype.reset = function() {
  this.points = [];
}
