...
app.Paintbrush = function($elem, name) {
  app.TextureDrawer.call(this, $elem, name, 0.5);
};
app.Paintbrush.prototype = Object.create(app.TextureDrawer.prototype);


app.Paintbrush.prototype.getTextureImage = function(color) {
  return this.getSVGTexture(color);
};

app.Paintbrush.prototype.getSVGString = function(color) {
