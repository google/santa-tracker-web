...
app.Ornament.prototype.addEventListeners = function() {
  $(window).on({
    'resize.seasonofcaring': this.resize.bind(this),
    'touchend.seasonofcaring mouseup.seasonofcaring': this.globalMouseUp.bind(this),
    'touchstart.seasonofcaring mousedown.seasonofcaring': this.mouseDown.bind(this),
    'touchmove.seasonofcaring mousemove.seasonofcaring': this.mouseMove.bind(this)
  });
