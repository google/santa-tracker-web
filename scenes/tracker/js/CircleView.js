function createCircleViewConstructor() {
  /**
  ...
  CircleView.prototype = new google.maps.MVCObject();
  ...
  CircleView.prototype['center_changed'] = function() {
    this.render_();
  };
  ...
  CircleView.prototype.distTo_ = function(x, y) {
    return Math.sqrt(
        Math.pow(this.get('center').x - x, 2) +
        Math.pow(this.get('center').y - y, 2))
  };
