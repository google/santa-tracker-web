 ...
 */
app.world.Target = class extends app.world.LevelObject {
  ...
  buildBody_() {
    ...
    bodyDef.position.Set(this.initialWorldPos_.x, this.initialWorldPos_.y - app.Unit.toWorld(30));
    ...
    const worldHeight = app.Unit.toWorld(height);
