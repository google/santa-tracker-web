...
class Scene extends EventEmitter {
  ...
  init(canvas) {
    ...
    var prevDiff = -1;
     ...
     this.canvas.onpointerdown = pointerdown_handler;
     this.canvas.onpointermove = pointermove_handler;

     // Use same handler for pointer{up,cancel,out,leave} events since
     // the semantics for these events - in this app - are the same.
     this.canvas.onpointerup = pointerup_handler;
     this.canvas.onpointercancel = pointerup_handler;
     this.canvas.onpointerout = pointerup_handler;
     this.canvas.onpointerleave = pointerup_handler;
