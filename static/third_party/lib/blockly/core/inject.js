...
Blockly.parseOptions_ = function(options) {
  ...
  var hasTouch = options['touch'];
  if (hasTouch === undefined) {
    hasTouch = goog.events.BrowserFeature.TOUCH_ENABLED;
  }

  var toolboxLayout = options['toolboxLayout'] || null;

  Blockly.RTL = !!options['rtl'];
  Blockly.touch = hasTouch;
  ...
  Blockly.toolboxLayout = toolboxLayout;
};
  ...
  */
  ...
  if (!Blockly.readOnly) {
    ...
    if (Blockly.hasCategories) {
      ...
      flyout.layoutProvider = Blockly.toolboxLayout;
